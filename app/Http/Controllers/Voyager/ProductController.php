...
class ProductController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view('vendor.voyager.products.edit', compact('dataType', 'dataTypeContent', 'isModelTranslatable'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view('vendor.voyager.products.add', compact('dataType', 'dataTypeContent', 'isModelTranslatable'));
    }
