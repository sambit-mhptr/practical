...
class CategoryController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
       ...
       /*  $view = 'voyager::bread.edit-add';
        ...
        return Voyager::view('vendor.voyager.categories.edit', compact('dataType', 'dataTypeContent', 'isModelTranslatable'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view('vendor.voyager.categories.add', compact('dataType', 'dataTypeContent', 'isModelTranslatable'));
    }
