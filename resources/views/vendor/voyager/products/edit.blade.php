...
<div class="form-group  col-md-12">
        ...
        <input type="text" id="name" class="form-control" name="name" placeholder="Name" value="{{ $dataTypeContent->name }}" autofocus>
        @error('name')
        ...
        <div class="form-group  col-md-12">
                ...
                <textarea class="form-control richTextBox" name="description" id="richtextbody" aria-hidden="true">{{ $dataTypeContent->description }}</textarea>
                @error('description')
                <span class="help-block text-danger">{{ $message }}</span>
                @enderror
        </div>                  
        ...
        <input type="text" id="price" class="form-control" name="price" placeholder="Price" value="{{ $dataTypeContent->price }}">
         @error('price')
                <span class="help-block text-danger">{{ $message }}</span>
        @enderror
        </div>       
        ...
        <img src="{{ asset('storage/products'.$dataTypeContent->image ) }}" alt="" style="width:200px">
        @endif
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <div class="form-check">
                    ...
                    @if(in_array($cat->id, $dataTypeContent->categories->pluck('id')->toArray())) checked @endif>
